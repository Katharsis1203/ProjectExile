...
export default function HubPlayerPanel({
  ...
  return (
    <aside
      ...
      className="relative flex min-w-0 xl:col-start-1 xl:row-start-1"
    >
        ...
        <section className="relative mb-[-28px] flex min-h-0 flex-1 flex-col px-5 pb-[42px] pt-5 text-[#2b2b2b]">
          ...
          <div className="relative z-40 mt-3 border-t border-[#6c5942]/12 pt-3">
            <div className="mb-2 flex items-center justify-between">
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#584a3b]/70">
                Condition
              </p>
              <span className="text-[9px] uppercase tracking-[0.12em] text-[#655440]/65">
                Current
              </span>
            </div>
          ...
          <div className="relative z-50 mt-3 border-t border-[#6c5942]/12 pt-3">
            <div className="mb-2 flex items-center justify-between gap-2">
              ...
              <span className="text-[9px] text-[#655440]/65">
                focus or hover for details
              </span>
            </div>
