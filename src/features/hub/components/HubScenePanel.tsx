    ...
    <main className="hub-panel-elevation hub-panel-elevation--scene flex min-w-0 items-center justify-center xl:col-start-2 xl:row-start-1">
      <div className="relative h-full w-full">
        <section
          ...
          className="relative flex h-full min-h-[440px] w-full flex-col bg-[length:100%_100%] bg-center bg-no-repeat p-5 text-[#2b2b2b] sm:min-h-[540px]"
